...
int main(int argc, char *argv[])
{
    ...
    tasks *task2=new tasks(&w,QString("3"),QString("2"),QString("1"),QString("0"),QString("5"),QString("F"));
    tasks *task3=new tasks(&w,QString("4"),QString("2"),QString("2"),QString("0"),QString("5"),QString("F"));
